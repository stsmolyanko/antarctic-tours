...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var navigationContainer = document.querySelector('.header__nav');
  var navigationList = document.querySelector('.header__navigation-list');
  var navigationOverlay = document.querySelector('.header__menu-bg');
  var burger = document.querySelector('.burger');
  var logoWhite = document.querySelector('.header__logo--white');
  var logoBlue = document.querySelector('.header__logo--blue');
  var cruiseDescription = document.querySelector('.cruises__description');
  var cruisesList = document.querySelector('.cruises__list');
